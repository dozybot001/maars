...
from .llm_client import chat_completion, merge_phase_config
from .utils import get_idea_text, parse_json_response

# ---------------------------------------------------------------------------
# Internal helpers (previously in reflection_helpers.py)
# ---------------------------------------------------------------------------
