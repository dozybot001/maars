...
See STAGE_LAYOUT_RULES.md for full sorting and alignment rules.
"""
...
from planner.layout.constants import (
    DEFAULT_NODE_H,
    DEFAULT_NODE_SEP,
    DEFAULT_NODE_W,
    DEFAULT_PADDING,
...
def compute_execution_graph_layout(tasks):
    """Stage-based layout for Execution Graph sub-view."""
