"""
Planner visualization - Decomposition Tree, Task Grid, Execution Graph.
...
from planner.visualization.layout import compute_execution_graph_layout
from planner.visualization.timetable import build_task_layout
from planner.visualization.tasks.task_cache import build_tree_data
...
def build_layout_from_execution(execution: Any) -> Dict:
    ...
    result["layout"] = compute_execution_graph_layout(result.get("treeData") or tree_data)
    return result
