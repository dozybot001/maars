"""
Compute task stages from flat task list.
Uses plan.graph.build_dependency_graph, networkx for topological sort and transitive reduction.
"""
...
from plan.graph import build_dependency_graph
